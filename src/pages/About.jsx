    ...
    <div className={styles.container}>
      <div className={styles.hero}>
        ...
        <div className={styles.heroSubtitle}>
          A comprehensive showcase of Microsoft's design system and component library
        </div>
      </div>
      ...
      <div className={styles.mainContent}>
        <div className={styles.section}>
          ...
          <Body1 className={styles.contentText}>
            ...
            for creating beautiful, accessible web applications. It's the foundation behind 
            Microsoft products like Office 365, Teams, and Azure, ensuring consistency and 
            quality across the entire Microsoft ecosystem.
          </Body1>
          <Body1 className={styles.contentText}>
            This demo showcases Fluent UI React v9 components, representing the latest generation 
            of Microsoft's design system. Built with modern React patterns, accessibility best 
            practices, and performance optimizations, these components are designed for 
        ...
        <div className={styles.section}>
          ...
          <Body1 className={styles.contentText}>
            This demonstration application was built using modern web technologies 
            and Microsoft's recommended development stack:
          </Body1>
